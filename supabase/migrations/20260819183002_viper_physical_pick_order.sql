+-- Future Foundation v1: replace Viper materialization so operational pick-line\n-- sequence follows explicit physical warehouse order. Existing jobs are not\n-- touched; only newly materialized jobs use this function definition.
